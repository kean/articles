...
[Pulse](https://github.com/kean/Pulse) is a logging system for Apple platforms. Pulse 2.0 is almost a complete rewrite that focuses on both adding new major features that there are plenty and optimizing the performance.
