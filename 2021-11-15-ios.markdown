...
Last week, I made [a poll](https://twitter.com/a_grebenyuk/status/1458158375942950916?s=20) on Twitter asking to share the best learning materials for iOS engineers, and I was overwhelmed with the number of responses it got. It was very insightful, and I thought it would be nice to compile the results into a single post, which I did here, adding a few recommendations of my own.
...
The lectures of the Stanford University's course CS193p were one of the top-recommended resources. I went through the first few videos myself and was blown by how packed they are with information.
...
- It focuses on SwiftUI. We are still in the transition period where most companies use UIKit, but it’s worth investing time into SwiftUI now. And you learn much more than just SwiftUI in this course.
...
The second most recommended resource is [100 Days of Swift](https://www.hackingwithswift.com/100). And it's not the only resource on [Hacking with Swift](https://www.hackingwithswift.com) by [Paul Hudson](https://twitter.com/twostraws). For example, there is a similar course on SwiftUI - [100 Days of SwiftUI](https://www.hackingwithswift.com/100/swiftui).
...
It’s uncommon for a paid resource to get a lot of recommendations, but this course was recommended by quite a few people and that's why it made the shortlist. I wasn’t able to check it out myself, but if you look at the course’s content, it looks impressive. I think right now it might be a better option than Standford’s CS193p if you want to focus on the current technologies, such as UIKit.
...
This resource doesn't need an introduction. I often find myself using it in my daily work. Ray Wanderlich is the go-to place for finding tutorials on specific topics. But it has more than that. It also has [courses](https://www.raywenderlich.com/ios/paths), [videos](https://www.raywenderlich.com/ios/videos), [articles](https://www.raywenderlich.com/ios/articles), and even [books](https://www.raywenderlich.com/ios/books). If there is an iOS topic you are interested in, chances are you'll find it on this site.

### [objc.io](objc.io)
<p class="blog-inner-subtitle">Indermediate/Advanced, Free/Paid</p>

[objc.io](objc.io) is one of the early resources covering a variety of advanced topics on iOS. I loved the format where each Issue would focus on a particular topic and have articles from multiple authors – it was one of my favorite resources when I was getting started.

The site has evolved and now features [videos](https://talk.objc.io) and [books](https://www.objc.io).
The topics can be quite advanced, so they are probably not suitable for beginners.
...
- [The Swift Programming Language](https://docs.swift.org/swift-book/) – reading this book is how I learned Swift in 2014. It was the _only_ resource on the language. It's a concise and well-written book and is a must-read.
...
There are so many [technologies](https://developer.apple.com/documentation/technologies) on Apple platforms that you can’t just go and preemptively learn everything. The way I typically learn a new technology is by first going through a quick tutorial and applying it in practice,and then learning the rest of the details using the official documentation.

I find it hard to learn anything preemptively. It's best when you have a project and you have a need. When you have a need, you have all the motivation you need to study something. Writing an article can also be a good motivator for learning the topic in depth – it generates the need because you don't want your article to be bad.

## Other Recommendations

I received a ton of recommendations in the original [poll](https://twitter.com/a_grebenyuk/status/1458158375942950916?s=20). Here I'm going to list the ones that didn't make the shortlist, in no particular order. A word of caution – Apple platforms are constantly evolving, make sure what you are reading is updated.

- [Donny Walls](https://twitter.com/DonnyWals)'s [blog](https://www.donnywals.com/the-blog/) and [books](https://www.donnywals.com/books/): [Practical Combine](https://donnywals.gumroad.com/l/practical-combine) and [Practical Core Data](https://donnywals.gumroad.com/l/practical-core-data)
...
I'd like to add a couple of resources myself: [iOS Dev Weekly](https://iosdevweekly.com), [NSHipster](https://nshipster.com), [Use Your Load](https://useyourloaf.com), [Cocoa with Love](https://www.cocoawithlove.com), [Little Bites of Cocoa](https://littlebitesofcocoa.com), [Krzysztof Zabłocki](http://merowing.info/post/), [Ole Begemann](https://oleb.net), [Increment](https://increment.com/issues/).

## Software Engineering

There is more to software engineering than learning a programming language and a platform you are working on. If you want to get a competitive advantage among other engineers, especially if you don’t have a CS degree, make sure to invest time into learning the fundamentals. The good news is that degrees are extremely overrated – you can learn everything they do and more by yourself. It’s not like you need any special equipment or anything.

An incomplete list of everything that you should/can learn (in no particular order):

- **Git**. There are a ton of resources on Git, but I found [Pro Git](https://github.com/git-guides/) to be the most insightful.
- **Release and Branching Strategies**. I think Trunk-Based Development is hands down the best branching strategy, especially for a larger team. [This website](https://trunkbaseddevelopment.com) is a fantastic place to learn it.
- **Algorithms and Data Structures**. There are many ways to learn it. I like [The Algorithm Design Manual](https://www.amazon.com/Algorithm-Design-Manual-Steven-Skiena/dp/1849967202), Steven Skiena and [Introduction to Algorithms](https://www.amazon.com/Introduction-Algorithms-3rd-MIT-Press/dp/0262033844), Thomas H. Cormen. The former is more approachable.
- **Terminal and Bash**. There are a ton of resources to learn them. For me, Swift largely replaced Bash as a scripting language of choice, but I still find myself using Bash often enough that it's worth investing time into learning it.
...
This isn't a complete list by any measure. There are a variety of specializations in software engineering. You can learn anything if you put your mind to it. I think every perspective is valuable. For example, if you are a mobile engineer, it doesn't mean that you can't explore a bit of backend development (especially now that's it can be done in Swift).

## Interviews

So you learned everything about iOS and software engineering, now you are done, right? Not quite. There is software engineering and there are software engineering interviews. There is some intersection between the two, but completing coding challenges on an interview has almost nothing in common with your job.

Fortunately, there are a ton of tools to help with preparation for interviews. The gold standard is [Cracking the Coding Interview](https://www.amazon.com/Cracking-Coding-Interview-Programming-Questions/dp/0984782850/ref=sr_1_1?gclid=Cj0KCQiAhMOMBhDhARIsAPVml-Enj4_92p_aL0INssZJFmQR4bpQuhIu9TMlOySo3et6QtwnzR_dEqYaAqIgEALw_wcB&hvadid=241870593966&hvdev=c&hvlocphy=9003488&hvnetw=g&hvqmt=e&hvrand=16845426662624439861&hvtargid=kwd-20040243067&hydadcr=16409_10304044&keywords=cracking+the+coding+interview&qid=1636928527&qsid=147-7803069-3350963&sr=8-1&sres=0984782850%2C1466208686%2CB09BGKJ3FL%2C0984782869%2CB09559NJKL%2C1537713949%2C1793296634%2C111941847X%2C1519089864%2CB00ISYMUR6%2CB08B3FWYBX%2C0578973839%2CB00U2YQ1Z2%2CB08VL1BLHB%2CB08X8ZXT15%2CB01D24NAL6&srpt=ABIS_BOOK), this is hands down the best resource that can help you prepare. I would also recommend [leetcode](https://leetcode.com). Another great resource is [Tech Interview Handbook](https://techinterviewhandbook.org/introduction/). 

Despite what the interviewers will tell about how it’s not about the speed and how they want to see your thinking… it’s primarily about the speed. You are measured against other candidates. The more you can demonstrate within the limited timeframe of an interview, the better. So it’s absolutely crucial to set a timer and optimize for speed.

## Final Thoughts

Everyone’s path in software engineering is different. It’s highly technical and it requires a ton of time investment. But it can also be extremely rewarding and fun. I hope you’ll find some of the resources from this post useful and they'll inspire you to learn!