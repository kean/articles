...
disable-toc: true
image:
  path: /images/posts/macos/cover.png
  height: 1200
  width: 675
---
...
<img class="NewScreenshot full-width" src="{{ site.url }}/images/posts/pulse-pro/main-console-04.png">
</a>
...
[jq](https://github.com/stedolan/jq) is a tool for processing JSON, applying the given filter. You can fidn some examples of what it can do at the [jq website](https://stedolan.github.io/jq"). It's really-really powerful and Pulse Pro makes it super nice to use with side-by-side live results view, and nice output formatting.
...
Pulse Pro is [available today](https://github.com/kean/PulsePro) for all of the sponsors as an early preview. I thank everyone who is sponsoring projects like Pulse and [Nuke](https://github.com/kean/Nuke). If you are not supporting it yet, it's easy to do [on GitHub](https://github.com/sponsors/kean), and you can get access to Pulse Pro now.
